 ...
 * (C:\\Users\\Tal Itshayek\\.aws\\credentials) where the sample code will load the credentials from.
 * <p>
...
public class CloudFormationSample {
    ...
    public static void main(String[] args) throws Exception {
         ...
         * (C:\\Users\\Tal Itshayek\\.aws\\credentials).
         */
        ...
        try {
            ...
            throw new AmazonClientException(
                    ...
                    "location (C:\\Users\\Tal Itshayek\\.aws\\credentials), and is in valid format.",
                    e);
        }
